...
Public Module Module1
    ...
    Sub checar(ByVal s As String)
        ...
        Catch ex As Exception
            Console.Write("El argumento no esta bien")
            Console.WriteLine()
        ...
        If File.Exists(r) = True Then
            ...
            If r.ToUpper.EndsWith(".EVT") Then
                ...
                If nombre <> "" Then
                    ...
                    If "ABCDEFGHIJKLMNOPQRSTUVWXYZ".Contains(nombre.Substring(1)) = False Then
                        nombre = ".0"
                    End If
                Else
                    nombre = ".0"
                ...
                For Each FileInf In ArrFileInfo
                    ...
                    Console.Write("Le prefijo " & nombre & " se agrega a la extension de los archivos descomprimidos" & vbNewLine)
