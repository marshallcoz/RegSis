...
<Serializable()> Public Class ClassBox
    ...
    Private RutaBox As String = Environment.CurrentDirectory & "\Box.opt"    'Ruta al archivo Box donde se guarda todo
    Private Lista(0) As String     'la lista exportada

    Public Property RutaExportada() As Array          'Con ésta propiedad se asignan o se leen los valores de LaRuta exportada
        Get
            Return Lista
        End Get
