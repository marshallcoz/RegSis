...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Filtro))
        ...
        Me.CheckBox15.Location = New System.Drawing.Point(258, 32)
        Me.CheckBox15.Name = "CheckBox15"
        Me.CheckBox15.Size = New System.Drawing.Size(69, 24)
        Me.CheckBox15.TabIndex = 10
        Me.CheckBox15.Text = "Canal 11"
        ...
        Me.CheckBox16.Location = New System.Drawing.Point(327, 32)
        Me.CheckBox16.Name = "CheckBox16"
        Me.CheckBox16.Size = New System.Drawing.Size(69, 24)
        Me.CheckBox16.TabIndex = 11
        Me.CheckBox16.Text = "Canal 12"
        ...
        Me.CheckBox17.Location = New System.Drawing.Point(189, 32)
        Me.CheckBox17.Name = "CheckBox17"
        Me.CheckBox17.Size = New System.Drawing.Size(69, 24)
        Me.CheckBox17.TabIndex = 9
        Me.CheckBox17.Text = "Canal 10"
        ...
        Me.CheckBox18.Location = New System.Drawing.Point(127, 32)
        Me.CheckBox18.Name = "CheckBox18"
        Me.CheckBox18.Size = New System.Drawing.Size(62, 24)
        Me.CheckBox18.TabIndex = 8
        Me.CheckBox18.Text = "Canal 9"
        ...
        Me.CheckBox11.Location = New System.Drawing.Point(3, 32)
        Me.CheckBox11.Name = "CheckBox11"
        Me.CheckBox11.Size = New System.Drawing.Size(62, 24)
        Me.CheckBox11.TabIndex = 6
        Me.CheckBox11.Text = "Canal 7"
        ...
        Me.CheckBox12.Location = New System.Drawing.Point(65, 32)
        Me.CheckBox12.Name = "CheckBox12"
        Me.CheckBox12.Size = New System.Drawing.Size(62, 24)
        Me.CheckBox12.TabIndex = 7
        Me.CheckBox12.Text = "Canal 8"
        ...
        Me.CheckBox13.Location = New System.Drawing.Point(313, -2)
        Me.CheckBox13.Name = "CheckBox13"
        Me.CheckBox13.Size = New System.Drawing.Size(62, 24)
        Me.CheckBox13.TabIndex = 5
        Me.CheckBox13.Text = "Canal 6"
        ...
        Me.CheckBox14.Location = New System.Drawing.Point(251, -2)
        Me.CheckBox14.Name = "CheckBox14"
        Me.CheckBox14.Size = New System.Drawing.Size(62, 24)
        Me.CheckBox14.TabIndex = 4
        Me.CheckBox14.Text = "Canal 5"
        ...
        Me.CheckBox10.Location = New System.Drawing.Point(189, -2)
        Me.CheckBox10.Name = "CheckBox10"
        Me.CheckBox10.Size = New System.Drawing.Size(62, 24)
        Me.CheckBox10.TabIndex = 3
        Me.CheckBox10.Text = "Canal 4"
        ...
        Me.RadioButton3.Size = New System.Drawing.Size(127, 30)
        ...
        'RadioButton2
        '
        Me.RadioButton2.Location = New System.Drawing.Point(150, 20)
        ...
        Me.CheckBox8.Location = New System.Drawing.Point(452, 45)
        ...
        Me.CheckBox7.Location = New System.Drawing.Point(452, 21)
        ...
        Me.CheckBox9.Location = New System.Drawing.Point(452, -2)
...
#Region "Filtro por fecha"
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If RBmodif.Checked = True Then
            ...
            For Each lvitm In LV3.Items
                If Now.Compare(CDate(lvitm.SubItems(2).Text), DateTimePicker1.Value) >= 0 _
                And Now.Compare(CDate(lvitm.SubItems(2).Text), DateTimePicker2.Value) <= 0 Then
        ...
        Else
            ...
            For Each lvitm In LV3.Items
                If Now.Compare(CDate(lvitm.SubItems(3).Text), DateTimePicker1.Value) >= 0 _
                And Now.Compare(CDate(lvitm.SubItems(3).Text), DateTimePicker2.Value) <= 0 Then
                    LVaux.Items.Add(lvitm.Clone)
                End If
            Next
        End If
...
#End Region
    ...
    <System.Diagnostics.DebuggerStepThrough()> Function copiar(ByVal lvOrigen As ListView, ByVal lvDestino As ListView)
...
#Region "filtro por tipo de archivo"
    ...
    Function cEVT()
        If CheckBox9.Checked = False Then
            For Each lvitm In LV3.Items
                If Path.GetExtension(lvitm.Text).ToUpper = ".EVT" Then
                    lvitm.Remove()
                End If
            Next
        Else
    ...
    Function cHD()
        If CheckBox7.Checked = False Then
            For Each lvitm In LV3.Items
                If Path.GetExtension(lvitm.Text).ToUpper.StartsWith(".HD") Then
                    lvitm.Remove()
                End If
            Next
        Else
    ...
    Function cSH()
        If CheckBox8.Checked = False Then
            For Each lvitm In LV3.Items
                If Path.GetExtension(lvitm.Text).ToUpper.StartsWith(".SH") Then
                    lvitm.Remove()
                End If
            Next
        Else
    ...
    Private Sub RadioButton1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadioButton1.CheckedChanged
        ...
        If RadioButton1.Checked = True Then
            For Each lvitm In LV3.Items
                If Path.GetExtension(lvitm.Text).ToUpper.EndsWith("P") Then
                    lvitm.Remove()
                End If
            Next
    ...
    Private Sub RadioButton2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadioButton2.CheckedChanged
        ...
        If RadioButton2.Checked = True Then
            For Each lvitm In LV3.Items
                If Not Path.GetExtension(lvitm.Text).ToUpper.EndsWith("P") Then
                    lvitm.Remove()
                End If
            Next
            CheckBox7.Checked = False
...
#End Region
    ...
    Private Sub LV3_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LV3.SelectedIndexChanged
